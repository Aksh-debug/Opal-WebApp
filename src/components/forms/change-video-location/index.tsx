...
const ChangeVideoLocation=({videoId,currentFolderName,currentWorkspace,currentFolder}:Props)=>{

    const {register,isPending,onFormSubmit,folders,workspaces,isFetching,isFolders}=useMoveVideos(videoId,currentWorkspace!)
